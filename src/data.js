export const sliderItems =[
  ...
  },
  {
      ...
      title: "QCY T13 " ,
      desc: "از طراحی داخل گوش و جذابی بهره می‌برد. درایور 7.2 میلی‌متری دینامیک آن صدای شفاف و هیجان‌انگیزی را تولید و ماژول بلوتوث 5.1 اتصال سریع و پایداری را میسر می‌کند. باتری هندزفری و کیس مجموعا 40 ساعت شارژدهی را به کاربر ارائه می‌دهند" ,
      bg: "d1dfcdee" ,
  },
];
